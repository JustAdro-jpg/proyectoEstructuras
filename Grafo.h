...
public:
    ...
    // Como no usamos punteros crudos, NO necesitamos destructor,
    // ni constructor de copia, ni operador = manuales.
    // El compilador se encarga y hace copia profunda del vector.
